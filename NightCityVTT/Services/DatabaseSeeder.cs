...
public class DatabaseSeeder
{
    ...
    [
        // Rockerboy gear
        new GearItem { Name = "Microphone (Broadcast-Quality)", Category = "Equipment",  ForRole = "Rockerboy", Description = "High-end broadcast mic for concerts and guerrilla broadcasts.", CostEurobucks = 200,  Concealability = "N/A", Availability = "Common" },
        new GearItem { Name = "Electric Guitar (Custom)",       Category = "Instrument",  ForRole = "Rockerboy", Description = "Custom shred guitar with built-in amp jack.",               CostEurobucks = 500,  Concealability = "N/A", Availability = "Common" },
        new GearItem { Name = "Light Armorjack (SP14)",         Category = "Armor",       ForRole = "Rockerboy", Description = "Fashionable armored jacket — SP14.",                        CostEurobucks = 150,  Concealability = "J",   Availability = "Common" },
        new GearItem { Name = "Medscanner",                     Category = "Medical",     ForRole = "Rockerboy", Description = "Handheld medical scanner for quick diagnostics.",            CostEurobucks = 300,  Concealability = "P",   Availability = "Common" },

        // Solo gear
        new GearItem { Name = "Medium Pistol (9mm)",            Category = "Weapon",      ForRole = "Solo",      Description = "Standard 9mm pistol. 2d6+1 damage, 15-round magazine.",    CostEurobucks = 250,  Concealability = "P",   Availability = "Common" },
        new GearItem { Name = "Body Armor (SP20)",              Category = "Armor",       ForRole = "Solo",      Description = "Military-grade body armor — SP20.",                         CostEurobucks = 700,  Concealability = "N/A", Availability = "Rare"   },
        new GearItem { Name = "Combat Knife",                   Category = "Weapon",      ForRole = "Solo",      Description = "High-carbon steel fighting knife. 1d6+2 damage.",          CostEurobucks = 30,   Concealability = "P",   Availability = "Common" },
        new GearItem { Name = "Medscanner",                     Category = "Medical",     ForRole = "Solo",      Description = "Handheld medical scanner for quick diagnostics.",            CostEurobucks = 300,  Concealability = "P",   Availability = "Common" },

        // Netrunner gear
        new GearItem { Name = "Cyberdeck (Standard)",           Category = "Cyberware",   ForRole = "Netrunner", Description = "Standard cyberdeck; 30 MU program space, 5 options.",       CostEurobucks = 1000, Concealability = "J",   Availability = "Rare"   },
        new GearItem { Name = "Neural Interface (Basic)",       Category = "Cyberware",   ForRole = "Netrunner", Description = "Basic neural link allowing deck connection.",                CostEurobucks = 500,  Concealability = "N/A", Availability = "Common" },
        new GearItem { Name = "Light Armorjack (SP14)",         Category = "Armor",       ForRole = "Netrunner", Description = "Light armored jacket — SP14.",                              CostEurobucks = 150,  Concealability = "J",   Availability = "Common" },
        new GearItem { Name = "Pocket Computer",                Category = "Equipment",   ForRole = "Netrunner", Description = "Powerful handheld computer for offline work.",               CostEurobucks = 200,  Concealability = "P",   Availability = "Common" },

        // Tech gear
        new GearItem { Name = "Basic Tool Kit",                 Category = "Equipment",   ForRole = "Tech",      Description = "Complete set of hand tools for mechanical and electronic work.", CostEurobucks = 200, Concealability = "N/A", Availability = "Common" },
        new GearItem { Name = "Electronic Multi-Meter",         Category = "Equipment",   ForRole = "Tech",      Description = "Diagnostic tool for circuits and power systems.",            CostEurobucks = 100,  Concealability = "P",   Availability = "Common" },
        new GearItem { Name = "Light Armorjack (SP14)",         Category = "Armor",       ForRole = "Tech",      Description = "Work-worn armored jacket — SP14.",                          CostEurobucks = 150,  Concealability = "J",   Availability = "Common" },
        new GearItem { Name = "Medscanner",                     Category = "Medical",     ForRole = "Tech",      Description = "Handheld medical scanner.",                                  CostEurobucks = 300,  Concealability = "P",   Availability = "Common" },

        // Medtech gear
        new GearItem { Name = "Medscanner (Advanced)",          Category = "Medical",     ForRole = "Medtech",   Description = "Advanced model with full diagnostic suite.",                 CostEurobucks = 500,  Concealability = "J",   Availability = "Rare"   },
        new GearItem { Name = "Trauma Team Card (3 Uses)",      Category = "Medical",     ForRole = "Medtech",   Description = "Prepaid Trauma Team extraction — 3 uses.",                  CostEurobucks = 1000, Concealability = "P",   Availability = "Common" },
        new GearItem { Name = "Pharmaceuticals (Stimpak x5)",   Category = "Medical",     ForRole = "Medtech",   Description = "Stimulant injectors; restore 1 BODY for 1 hour.",            CostEurobucks = 250,  Concealability = "P",   Availability = "Common" },
        new GearItem { Name = "Light Armorjack (SP14)",         Category = "Armor",       ForRole = "Medtech",   Description = "Medical staff armored jacket — SP14.",                      CostEurobucks = 150,  Concealability = "J",   Availability = "Common" },

        // Media gear
        new GearItem { Name = "Broadcast Camera (Shoulder-Mount)", Category = "Equipment", ForRole = "Media",    Description = "Professional broadcast camera with uplink capability.",       CostEurobucks = 800,  Concealability = "N/A", Availability = "Common" },
        new GearItem { Name = "Digital Recorder",               Category = "Equipment",   ForRole = "Media",     Description = "High-quality audio/video recorder.",                         CostEurobucks = 150,  Concealability = "J",   Availability = "Common" },
        new GearItem { Name = "Press Pass (Authentic)",         Category = "Document",    ForRole = "Media",     Description = "Legitimate press credentials; opens many doors.",            CostEurobucks = 100,  Concealability = "P",   Availability = "Rare"   },
        new GearItem { Name = "Light Armorjack (SP14)",         Category = "Armor",       ForRole = "Media",     Description = "Discreet armored jacket — SP14.",                           CostEurobucks = 150,  Concealability = "J",   Availability = "Common" },

        // Cop gear
        new GearItem { Name = "Medium Pistol (Lawforce Issue)", Category = "Weapon",      ForRole = "Cop",       Description = "Standard issue sidearm. 2d6+1 damage, 15-round magazine.",  CostEurobucks = 250,  Concealability = "P",   Availability = "Common" },
        new GearItem { Name = "Handcuffs (Smart)",              Category = "Equipment",   ForRole = "Cop",       Description = "Electronic handcuffs with biometric lock.",                  CostEurobucks = 50,   Concealability = "J",   Availability = "Common" },
        new GearItem { Name = "Badge & ID",                     Category = "Document",    ForRole = "Cop",       Description = "Official badge granting arrest authority.",                  CostEurobucks = 0,    Concealability = "J",   Availability = "N/A"    },
        new GearItem { Name = "Medium Armor (SP18)",            Category = "Armor",       ForRole = "Cop",       Description = "Police-issue body armor — SP18.",                           CostEurobucks = 500,  Concealability = "N/A", Availability = "Common" },

        // Corporate gear
        new GearItem { Name = "Corporate SmartCard (1000 eb)", Category = "Finance",     ForRole = "Corporate", Description = "Corporate expense account card, loaded with 1000 eurobucks.", CostEurobucks = 1000, Concealability = "P",   Availability = "N/A"    },
        new GearItem { Name = "Business Suit (Armored)",        Category = "Armor",       ForRole = "Corporate", Description = "Tailored armored suit — SP10, looks completely civilian.",   CostEurobucks = 600,  Concealability = "J",   Availability = "Rare"   },
        new GearItem { Name = "Personal Computer (High-End)",   Category = "Equipment",   ForRole = "Corporate", Description = "Encrypted laptop with corporate network access.",             CostEurobucks = 500,  Concealability = "J",   Availability = "Common" },
        new GearItem { Name = "Pocket Secretary",               Category = "Equipment",   ForRole = "Corporate", Description = "Personal organizer, contacts database, and scheduler.",      CostEurobucks = 100,  Concealability = "P",   Availability = "Common" },

        // Fixer gear
        new GearItem { Name = "Communications Scrambler",       Category = "Equipment",   ForRole = "Fixer",     Description = "Encrypts voice and data transmissions.",                     CostEurobucks = 300,  Concealability = "J",   Availability = "Rare"   },
        new GearItem { Name = "Pocket Secretary",               Category = "Equipment",   ForRole = "Fixer",     Description = "Encrypted contacts and deal database.",                      CostEurobucks = 100,  Concealability = "P",   Availability = "Common" },
        new GearItem { Name = "Light Armorjack (SP14)",         Category = "Armor",       ForRole = "Fixer",     Description = "Stylish armored jacket — SP14.",                            CostEurobucks = 150,  Concealability = "J",   Availability = "Common" },
        new GearItem { Name = "Hold-Out Pistol",                Category = "Weapon",      ForRole = "Fixer",     Description = "Easily concealed light pistol. 2d6 damage.",                CostEurobucks = 200,  Concealability = "P",   Availability = "Common" },

        // Nomad gear
        new GearItem { Name = "Motorcycle (Pack-Issue)",        Category = "Vehicle",     ForRole = "Nomad",     Description = "Rugged off-road motorcycle. Pack markings on tank.",         CostEurobucks = 2000, Concealability = "N/A", Availability = "Rare"   },
        new GearItem { Name = "Light Armorjack (SP14)",         Category = "Armor",       ForRole = "Nomad",     Description = "Road-worn armored jacket — SP14.",                          CostEurobucks = 150,  Concealability = "J",   Availability = "Common" },
        new GearItem { Name = "Hunting Rifle",                  Category = "Weapon",      ForRole = "Nomad",     Description = "Bolt-action rifle. 5d6 damage, excellent range.",           CostEurobucks = 400,  Concealability = "N/A", Availability = "Common" },
        new GearItem { Name = "Basic Tool Kit",                 Category = "Equipment",   ForRole = "Nomad",     Description = "Essential tools for road repairs and field maintenance.",    CostEurobucks = 200,  Concealability = "N/A", Availability = "Common" },
        new GearItem { Name = "Eclipse Arms Specter", Category = "Weapon", Description = "Smartlinked 9mm with suppressor ports – netrunner favorite.", CostEurobucks = 650, Concealability = "P", Availability = "C", Acc = "+1", Damage = "1D6+1", Range = "50m", Capacity = "15", ROF = "3" },
        new GearItem { Name = "Viper Dynamics Street Judge", Category = "Weapon", Description = "Brutal .45 ACP for boostergang muscle.", CostEurobucks = 450, Concealability = "J", Availability = "C", Acc = "0", Damage = "2D6+1", Range = "75m", Capacity = "10", ROF = "2" },
        new GearItem { Name = "Kang Tao Red Dragon", Category = "Weapon", Description = "Burst-fire pocket rocket with folding stock.", CostEurobucks = 780, Concealability = "J", Availability = "U", Acc = "0", Damage = "1D6", Range = "100m", Capacity = "32", ROF = "10" },
        new GearItem { Name = "Militech Avenger", Category = "Weapon", Description = "Standard 5.56mm with optional grenade launcher.", CostEurobucks = 1250, Concealability = "N", Availability = "R", Acc = "+1", Damage = "5D6", Range = "400m", Capacity = "30", ROF = "10" },
        new GearItem { Name = "NightEdge Ghost Blade", Category = "Weapon", Description = "Mono-edged smart-grip katana for samurai.", CostEurobucks = 1200, Concealability = "N", Availability = "R", Acc = "+1", Damage = "2D6+3", Range = "Melee", Capacity = "-", ROF = "-" },
        new GearItem { Name = "Thunderfist Shock Knuckles", Category = "Weapon", Description = "Brass knuckles with built-in stun capacitors.", CostEurobucks = 380, Concealability = "P", Availability = "C", Acc = "0", Damage = "1D6+2", Range = "Melee", Capacity = "-", ROF = "-" },
        new GearItem { Name = "Arasaka Wraith", Category = "Weapon", Description = "Suppressed .338 with thermal smart-scope.", CostEurobucks = 2100, Concealability = "N", Availability = "R", Acc = "+2", Damage = "6D6", Range = "800m", Capacity = "5", ROF = "1" },
        new GearItem { Name = "Roadblock 12ga", Category = "Weapon", Description = "Pump-action flechette monster.", CostEurobucks = 520, Concealability = "L", Availability = "C", Acc = "0", Damage = "4D6", Range = "25m", Capacity = "8", ROF = "2" },
        new GearItem { Name = "Militech Hellfire", Category = "Weapon", Description = "HE/flashbang launcher for clearing rooms.", CostEurobucks = 1850, Concealability = "N", Availability = "R", Acc = "-1", Damage = "Varies", Range = "150m", Capacity = "6", ROF = "1" },
        new GearItem { Name = "Kang Tao Lightning", Category = "Weapon", Description = "Silent electromagnetic dart gun.", CostEurobucks = 2450, Concealability = "J", Availability = "U", Acc = "+1", Damage = "3D6+2", Range = "60m", Capacity = "8", ROF = "2" },
        new GearItem { Name = "Arasaka Black Widow", Category = "Weapon", Description = "Compact smart-pistol with toxin dart option.", CostEurobucks = 950, Concealability = "P", Availability = "R", Acc = "+1", Damage = "2D6", Range = "40m", Capacity = "12", ROF = "3" },
        new GearItem { Name = "Militech Bulldog", Category = "Weapon", Description = ".50 cal beast that kicks like a mule.", CostEurobucks = 680, Concealability = "J", Availability = "C", Acc = "0", Damage = "3D6", Range = "80m", Capacity = "8", ROF = "2" },
        new GearItem { Name = "Nomad Sawtooth", Category = "Weapon", Description = "Rugged open-bolt SMG for badlands runs.", CostEurobucks = 920, Concealability = "L", Availability = "U", Acc = "0", Damage = "2D6", Range = "150m", Capacity = "40", ROF = "15" },
        new GearItem { Name = "Trauma Team Reaper", Category = "Weapon", Description = "Medical-corp carbine with underbarrel med-injector.", CostEurobucks = 1680, Concealability = "N", Availability = "R", Acc = "+1", Damage = "4D6+2", Range = "350m", Capacity = "25", ROF = "8" },
        new GearItem { Name = "Street Ronin Tanto", Category = "Weapon", Description = "Mono-tanto with hidden garrote wire.", CostEurobucks = 220, Concealability = "P", Availability = "C", Acc = "+2", Damage = "1D6+2", Range = "Melee", Capacity = "-", ROF = "-" },
        new GearItem { Name = "Kang Tao Firestorm", Category = "Weapon", Description = "Backpack flamer for clearing alleys.", CostEurobucks = 3100, Concealability = "N", Availability = "R", Acc = "-2", Damage = "4D6 fire", Range = "10m", Capacity = "6 shots", ROF = "1" },
        new GearItem { Name = "Arasaka Oni", Category = "Weapon", Description = "Tripod or vehicle-mounted shredder.", CostEurobucks = 4200, Concealability = "N", Availability = "R", Acc = "0", Damage = "7D6", Range = "500m", Capacity = "200", ROF = "20" },
        new GearItem { Name = "Viper Venom", Category = "Weapon", Description = "Silent injector pistol for covert takedowns.", CostEurobucks = 890, Concealability = "P", Availability = "U", Acc = "+1", Damage = "1D6+drug", Range = "30m", Capacity = "20", ROF = "4" },
        new GearItem { Name = "Militech Cyclone", Category = "Weapon", Description = "Gatling-style anti-personnel nightmare.", CostEurobucks = 6800, Concealability = "N", Availability = "R", Acc = "-1", Damage = "6D6", Range = "300m", Capacity = "500", ROF = "30" },
        new GearItem { Name = "NightEdge Razor Whip", Category = "Weapon", Description = "Mono-wire whip that slices limbs clean off.", CostEurobucks = 750, Concealability = "J", Availability = "U", Acc = "0", Damage = "3D6", Range = "4m", Capacity = "-", ROF = "-" },
        new GearItem { Name = "Kang Tao Dragonbreath", Category = "Weapon", Description = "Dragon-breath incendiary rounds.", CostEurobucks = 1450, Concealability = "L", Availability = "R", Acc = "-1", Damage = "5D6", Range = "20m", Capacity = "5", ROF = "1" },
        new GearItem { Name = "Arasaka Shadow", Category = "Weapon", Description = "Ghost-suit integrated stealth sniper.", CostEurobucks = 3800, Concealability = "N", Availability = "R", Acc = "+3", Damage = "5D6+1", Range = "1000m", Capacity = "10", ROF = "1" },
        new GearItem { Name = "Militech Hammer", Category = "Weapon", Description = "Disposable anti-vehicle rocket.", CostEurobucks = 5200, Concealability = "N", Availability = "R", Acc = "0", Damage = "8D6 AP", Range = "300m", Capacity = "1", ROF = "1" },
        new GearItem { Name = "Street Judge II", Category = "Weapon", Description = "Upgraded smart version with biometric lock.", CostEurobucks = 1100, Concealability = "J", Availability = "U", Acc = "+1", Damage = "2D6+2", Range = "90m", Capacity = "12", ROF = "3" },
        new GearItem { Name = "Nomad Chainsaw Arm", Category = "Weapon", Description = "Retractable chainsaw forearm implant.", CostEurobucks = 2800, Concealability = "N", Availability = "R", Acc = "0", Damage = "4D6", Range = "Melee", Capacity = "-", ROF = "-" },
        new GearItem { Name = "Eclipse Phantom", Category = "Weapon", Description = "Ultra-quiet integrated suppressor SMG.", CostEurobucks = 2100, Concealability = "J", Availability = "R", Acc = "+2", Damage = "2D6", Range = "120m", Capacity = "50", ROF = "12" },
        new GearItem { Name = "Kang Tao Thunderbolt", Category = "Weapon", Description = "Man-portable railgun for heavy solos.", CostEurobucks = 4500, Concealability = "N", Availability = "R", Acc = "+1", Damage = "4D6+3", Range = "600m", Capacity = "20", ROF = "3" },
        new GearItem { Name = "Trauma Team Pacifier", Category = "Weapon", Description = "Non-lethal crowd control for security.", CostEurobucks = 650, Concealability = "N", Availability = "C", Acc = "+1", Damage = "Stun 4D6", Range = "40m", Capacity = "10", ROF = "2" },
        new GearItem { Name = "Arasaka Demon", Category = "Weapon", Description = "Mini-grenade launcher disguised as pistol.", CostEurobucks = 1750, Concealability = "J", Availability = "R", Acc = "0", Damage = "Varies", Range = "80m", Capacity = "4", ROF = "1" },
        new GearItem { Name = "Viper Fang", Category = "Weapon", Description = "Switchblade with toxin reservoir.", CostEurobucks = 150, Concealability = "P", Availability = "C", Acc = "+2", Damage = "1D6+1", Range = "Melee", Capacity = "-", ROF = "-" },
        new GearItem { Name = "Arasaka Executive Vest", Category = "Armor", Description = "Looks like designer suit stops 9mm.", CostEurobucks = 850, SP = "12", EV = "0" },
        new GearItem { Name = "Militech Trooper Plate", Category = "Armor", Description = "Full torso trauma plates for corpsec.", CostEurobucks = 1450, SP = "20", EV = "-2" },
        new GearItem { Name = "Street Samurai Chrome Jacket", Category = "Armor", Description = "Ballistic mesh with neon chrome studs.", CostEurobucks = 420, SP = "8", EV = "0" },
        new GearItem { Name = "Nomad Dust Rider Duster", Category = "Armor", Description = "Kevlar + radiation lining for badlands.", CostEurobucks = 310, SP = "10", EV = "-1" },
        new GearItem { Name = "Netrunner Ghost Suit", Category = "Armor", Description = "EMP-shielded with deck ports.", CostEurobucks = 680, SP = "6", EV = "0" },
        new GearItem { Name = "Trauma Team Paramedic Vest", Category = "Armor", Description = "High-visibility with med-pouch slots.", CostEurobucks = 920, SP = "14", EV = "-1" },
        new GearItem { Name = "Arasaka Black Ops Bodysuit", Category = "Armor", Description = "Chameleon fabric + thermal dampening.", CostEurobucks = 2100, SP = "11", EV = "0" },
        new GearItem { Name = "Boostergang Leather & Spikes", Category = "Armor", Description = "Stylish but cheap street protection.", CostEurobucks = 180, SP = "7", EV = "0" },
        new GearItem { Name = "Militech Rhino Helmet", Category = "Armor", Description = "With built-in targeting HUD.", CostEurobucks = 650, SP = "18", EV = "-1" },
        new GearItem { Name = "Kang Tao Corporate Suit", Category = "Armor", Description = "Bulletproof business wear.", CostEurobucks = 1200, SP = "9", EV = "0" },
        new GearItem { Name = "Nomad Road Warrior Plate", Category = "Armor", Description = "Reinforced for high-speed crashes.", CostEurobucks = 890, SP = "13", EV = "-2" },
        new GearItem { Name = "Eclipse Shadow Cloak", Category = "Armor", Description = "Optical camo for netrunners.", CostEurobucks = 1450, SP = "5", EV = "0" },
        new GearItem { Name = "Street Doc Scrubs + Vest", Category = "Armor", Description = "Practical with multiple pockets.", CostEurobucks = 340, SP = "8", EV = "0" },
        new GearItem { Name = "Arasaka Oni Full Plate", Category = "Armor", Description = "Exo-assisted heavy combat suit.", CostEurobucks = 4500, SP = "22", EV = "-3" },
        new GearItem { Name = "Fixer’s Silk Armor Lining", Category = "Armor", Description = "Hidden under expensive suits.", CostEurobucks = 550, SP = "10", EV = "0" },
        new GearItem { Name = "Runner’s Edge Cyberdeck", Category = "Netrunning", Description = "Entry-level deck with 4 slots.", CostEurobucks = 2200 },
        new GearItem { Name = "Trauma Patch", Category = "Medical", Description = "Single-use nanite wound sealer.", CostEurobucks = 120 },
        new GearItem { Name = "Ghost Hands Lockpick Set", Category = "Tool", Description = "Neural-feedback electronic picks.", CostEurobucks = 85 },
        new GearItem { Name = "Chroma Spray Paint Kit", Category = "Misc", Description = "Neon RFID paint for tagging.", CostEurobucks = 45 },
        new GearItem { Name = "Nomad Sun Portable Charger", Category = "Tool", Description = "Solar backpack for cyberware.", CostEurobucks = 210 },
        new GearItem { Name = "Black ICE Data Chip", Category = "Netrunning", Description = "One-shot lethal program.", CostEurobucks = 950 },
        new GearItem { Name = "Kevlar Duffle Bag", Category = "Misc", Description = "20kg capacity bullet resistant.", CostEurobucks = 60 },
        new GearItem { Name = "Vita-Clone Synthetic Blood", Category = "Medical", Description = "Emergency transfusion pack.", CostEurobucks = 300 },
        new GearItem { Name = "Ghost Show Holo-Projector", Category = "Tool", Description = "Pocket 3D hologram distractor.", CostEurobucks = 420 },
        new GearItem { Name = "Fixer Black Book Comm", Category = "Communication", Description = "Quantum-encrypted burner phone.", CostEurobucks = 180 },
        new GearItem { Name = "Arasaka Data Worm", Category = "Netrunning", Description = "Stealth data extraction virus.", CostEurobucks = 650 },
        new GearItem { Name = "Medscanner", Category = "Medical", Description = "Handheld diagnostic tool.", CostEurobucks = 420 },
        new GearItem { Name = "Grapple Gun", Category = "Tool", Description = "50m monowire with winch.", CostEurobucks = 380 },
        new GearItem { Name = "Night Vision Goggles", Category = "Optics", Description = "Thermal + low-light.", CostEurobucks = 290 },
        new GearItem { Name = "Forged ID Card", Category = "Misc", Description = "High-quality fake corporate pass.", CostEurobucks = 750 },
        new GearItem { Name = "EMP Grenade", Category = "Combat", Description = "One-use electronics killer.", CostEurobucks = 150 },
        new GearItem { Name = "Cyberlimb Tool Kit", Category = "Medical", Description = "Portable repair station.", CostEurobucks = 1100 },
        new GearItem { Name = "Bug Detector", Category = "Security", Description = "Finds listening devices.", CostEurobucks = 220 },
        new GearItem { Name = "Smart Glasses", Category = "Optics", Description = "AR overlay + targeting.", CostEurobucks = 340 },
        new GearItem { Name = "Disposable Phone", Category = "Communication", Description = "Burner for one job only.", CostEurobucks = 30 },
        new GearItem { Name = "Flashbang Grenade", Category = "Combat", Description = "Non-lethal crowd control.", CostEurobucks = 80 },
        new GearItem { Name = "Cyberdeck Cooling Vest", Category = "Netrunning", Description = "Prevents overheating during runs.", CostEurobucks = 450 },
        new GearItem { Name = "Nomad Water Purifier", Category = "Survival", Description = "Makes badlands water drinkable.", CostEurobucks = 95 },
        new GearItem { Name = "Holo-Map of Night City", Category = "Tool", Description = "Updated street grid projector.", CostEurobucks = 120 },
        new GearItem { Name = "Mono-Wire Cutter", Category = "Tool", Description = "Cuts fences and cables silently.", CostEurobucks = 310 },
        new GearItem { Name = "Pain Editor Implant Patch", Category = "Medical", Description = "Blocks pain for 6 hours.", CostEurobucks = 80 },
        new GearItem { Name = "Corporate Suitcase (armored)", Category = "Misc", Description = "Conceals weapons biometric lock.", CostEurobucks = 650 },
        new GearItem { Name = "Street Food Vending Kit", Category = "Misc", Description = "Makes cheap kibble taste edible.", CostEurobucks = 40 },
        new GearItem { Name = "Signal Jammer", Category = "Security", Description = "Blocks radio/cell for 50m.", CostEurobucks = 520 },
        new GearItem { Name = "Laser Microphone", Category = "Espionage", Description = "Listens through windows.", CostEurobucks = 890 },
        new GearItem { Name = "Breath Mask", Category = "Survival", Description = "Filters toxic Night City air.", CostEurobucks = 110 },
        new GearItem { Name = "Data Chip Reader/Writer", Category = "Netrunning", Description = "Portable deck accessory.", CostEurobucks = 180 },
        new GearItem { Name = "Climbing Spikes (cyber)", Category = "Tool", Description = "Wall-crawling set.", CostEurobucks = 420 },
        new GearItem { Name = "Decoy Drone", Category = "Misc", Description = "Remote-controlled distraction.", CostEurobucks = 680 },
        new GearItem { Name = "Infrared Binoculars", Category = "Optics", Description = "500m range spotting.", CostEurobucks = 250 },
        new GearItem { Name = "Synthcoke (Boost)", Category = "Drug", Description = "+2 REF for 1 hour (addictive).", CostEurobucks = 25 },
        new GearItem { Name = "Zero Pain Editor Patch", Category = "Drug", Description = "Total pain block for 6 hours.", CostEurobucks = 80 },
        new GearItem { Name = "Smash (hallucinogen)", Category = "Drug", Description = "Euphoric trip popular in clubs.", CostEurobucks = 35 },
        new GearItem { Name = "Speedheal Nano", Category = "Medical", Description = "Accelerates healing by 50%.", CostEurobucks = 450 },
        new GearItem { Name = "Dorph (combat drug)", Category = "Drug", Description = "+1 BODY ignore 2 wounds.", CostEurobucks = 60 },
        new GearItem { Name = "Black Lace", Category = "Drug", Description = "Extreme high with cyberware boost.", CostEurobucks = 120 },
        new GearItem { Name = "Airhypo Injector", Category = "Medical", Description = "Needleless drug delivery.", CostEurobucks = 95 },
        new GearItem { Name = "Portable Faraday Cage", Category = "Security", Description = "Small bag blocks signals.", CostEurobucks = 310 }
    ];
}
